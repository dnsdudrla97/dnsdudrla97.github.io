...
{: width="70%" height="70%"}
### 안드로이드 앱의 시작점
![/assets/img/posts/Android/Droid/1.png](/assets/img/posts/Android/Droid/1.png)
```xml
...
```
### MainActivty1
![/assets/img/posts/Android/Droid/2.png](/assets/img/posts/Android/Droid/2.png)
...
![/assets/img/posts/Android/Droid/3.png](/assets/img/posts/Android/Droid/3.png)

    - `"google_sdk".equals(Build.PRODUCT)` ← `google/sdk_gphone_x86`

### MainActivity2 intent 요청 조건 분석

![/assets/img/posts/Android/Droid/4.png](/assets/img/posts/Android/Droid/4.png)

- Button을 누르면 길이가 (10 ≥ && ≤ 26) 일 경우 Main2Activity 를 호출

### MainActivity2

![/assets/img/posts/Android/Droid/5.png](/assets/img/posts/Android/Droid/5.png)
...
![/assets/img/posts/Android/Droid/6.png](/assets/img/posts/Android/Droid/6.png)
...
!![/assets/img/posts/Android/Droid/7.png](/assets/img/posts/Android/Droid/7.png)

- Root 권한이 존재하는 ADV Image이기 때문에 임의 액티비티 실행이 가능하다.
- 권한 상승후 해당 액티비티를 실행하게 되면 FLAG값을 얻을 수 있다.
![/assets/img/posts/Android/Droid/8.png](/assets/img/posts/Android/Droid/8.png)
### Hooking

- Frida를 통한 Hooking을 통해 체크 로직 우회

![/assets/img/posts/Android/Droid/9.png](/assets/img/posts/Android/Droid/9.png)

![/assets/img/posts/Android/Droid/10.png](/assets/img/posts/Android/Droid/10.png)
...
![/assets/img/posts/Android/Droid/11.png](/assets/img/posts/Android/Droid/11.png)
...
![/assets/img/posts/Android/Droid/12.png](/assets/img/posts/Android/Droid/9.png)
