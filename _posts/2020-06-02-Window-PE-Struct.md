...
thumbnail: /assets/img/posts/WindowExploit_post/dnsdudrla97_PE_Struct.png
---
# 윈도우 실행 파일 구조
...
- 섹션이 파일 상태에서는 사이즈가 0이지만 메모리에 로드된 후에는 용량이 커지는 경우도 존재
    ...
    ![/assets/img/posts/WindowExploit_post/dnsdudrla97_pe_strucut_main.png](/assets/img/posts/WindowExploit_post/dnsdudrla97_pe_strucut_main.png)
